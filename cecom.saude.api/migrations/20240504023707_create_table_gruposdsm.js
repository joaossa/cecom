...
exports.up = function(knex) {
  return knex.schema.createTable('gruposdsm', table => {
    ...
    table.string('ds_grupodsm', 250).notNull();
    table.integer('cd_grupodsmpai').references('cd_grupodsm').inTable('gruposdsm'); // Recursive foreign key to the same table
    table.integer('versao').check('versao IN (4, 5)'); // Check for DSM-IV (4) or DSM-5 (5)
